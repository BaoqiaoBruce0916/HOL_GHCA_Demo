...
- **Semantics first**: Let tests reinforce accessible markup. Favor assertions against landmark roles, button names, link names, and form labels rather than brittle CSS-driven selectors.
...
- [ ] Interactive UI is exercised through keyboard- and screen-reader-friendly semantics where applicable
